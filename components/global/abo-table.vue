...
import { DataTableHeader, DataTableItem, ItemPerPage } from '~/types/DataTable'
...
let currentItemsPerPage = reactive<ItemPerPage>({
  title: 5,
    ...
    <table class="abo-table">
      <thead class="thead">
        <tr class="row">
          ...
          <th class="col" v-if="!!slots.actions">Actions</th>
        </tr>
      </thead>
      <tbody class="tbody">
        <tr
    ...
    >
      <div class="d-flex align-center ml-auto">
        ...
        <v-select
          ...
          :modelValue="currentItemsPerPage"
